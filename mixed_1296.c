...
enum _1_main_$op {
    ...
    _1_main__ternary_int$left_STA_0$result_STA_0$right_STA_1$mid_STA_2 = 233,
    ...
    _1_main__Mod_int_int2int$right_STA_0$result_STA_0$left_STA_1 = 89,
    _1_main__Ne_int_int2int$left_STA_0$result_STA_0$right_STA_1 = 137
} ;
unsigned char _1_main_$array[1][205]  = { {        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
            ...
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__load_int$left_STA_0$result_STA_0, 
            _1_main__Ne_int_int2int$left_STA_0$result_STA_0$right_STA_1,        _1_main__ternary_int$left_STA_0$result_STA_0$right_STA_1$mid_STA_2,        _1_main__branchIfTrue$expr_STA_0$label_LAB_0,        (unsigned char)19, 
            ...
            _1_main__goto$label_LAB_0,        (unsigned char)98,        (unsigned char)0,        (unsigned char)0, 
            (unsigned char)0,        _1_main__goto$label_LAB_0,        (unsigned char)93,        (unsigned char)0, 
            (unsigned char)0,        (unsigned char)0,        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)16, 
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__load_int$left_STA_0$result_STA_0, 
            _1_main__constant_int$result_STA_0$value_LIT_0,        (unsigned char)2,        (unsigned char)0,        (unsigned char)0, 
            (unsigned char)0,        _1_main__Mod_int_int2int$right_STA_0$result_STA_0$left_STA_1,        _1_main__branchIfTrue$expr_STA_0$label_LAB_0,        (unsigned char)9, 
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__goto$label_LAB_0, 
            ...
            (unsigned char)0,        _1_main__store_int$left_STA_0$right_STA_1,        _1_main__call$func_LIT_0,        (unsigned char)2, 
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__goto$label_LAB_0, 
            (unsigned char)88,        (unsigned char)255,        (unsigned char)255,        (unsigned char)255, 
            _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)48,        (unsigned char)0,        (unsigned char)0, 
            (unsigned char)0,        _1_main__string$result_STA_0$value_LIT_0,        (unsigned char)7,        (unsigned char)0, 
            (unsigned char)0,        (unsigned char)0,        _1_main__convert_void_star2void_star$left_STA_0$result_STA_0,        _1_main__store_void_star$right_STA_0$left_STA_1, 
            _1_main__call$func_LIT_0,        (unsigned char)3,        (unsigned char)0,        (unsigned char)0, 
            (unsigned char)0,        _1_main__goto$label_LAB_0,        (unsigned char)66,        (unsigned char)255, 
            (unsigned char)255,        (unsigned char)255,        _1_main__goto$label_LAB_0,        (unsigned char)61, 
...
{ 
  ...
  while (1) {
    ...
    *((int *)(_1_main_$sp[0] + 0)->_void_star) = (_1_main_$sp[0] + -1)->_int;
    ...
    break;
    case 2: 
    printf(*((char const   * __restrict  *)(_1_main_$locals + 32)), *((int *)(_1_main_$locals + 40)));
    break;
    case 1: 
