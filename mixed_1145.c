...
enum _1_main_$op {
    ...
    _1_main__Mult_int_int2int$left_STA_0$result_STA_0$right_STA_1 = 150,
    ...
    _1_main__MinusA_int_int2int$left_STA_0$result_STA_0$right_STA_1 = 125,
    ...
    _1_main__Eq_int_int2int$right_STA_0$result_STA_0$left_STA_1 = 233
} ;
unsigned char _1_main_$array[1][258]  = { {        _1_main__call$func_LIT_0,        (unsigned char)1,        (unsigned char)0,        (unsigned char)0, 
            ...
            _1_main__store_void_star$right_STA_0$left_STA_1,        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)8,        (unsigned char)0, 
            ...
            _1_main__load_int$left_STA_0$result_STA_0,        _1_main__Ne_int_int2int$left_STA_0$result_STA_0$right_STA_1,        _1_main__branchIfTrue$expr_STA_0$label_LAB_0,        (unsigned char)14, 
            ...
            _1_main__goto$label_LAB_0,        (unsigned char)191,        (unsigned char)0,        (unsigned char)0, 
            ...
            (unsigned char)0,        _1_main__store_int$left_STA_0$right_STA_1,        _1_main__goto$label_LAB_0,        (unsigned char)33, 
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__constant_int$result_STA_0$value_LIT_0, 
            ...
            _1_main__Mult_int_int2int$left_STA_0$result_STA_0$right_STA_1,        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)20,        (unsigned char)0, 
            ...
            (unsigned char)46,        (unsigned char)255,        (unsigned char)255,        (unsigned char)255, 
...
{ 
  ...
  while (1) {
    ...
    *((void **)(_1_main_$sp[0] + -1)->_void_star) = (_1_main_$sp[0] + 0)->_void_star;
    ...
    case 3: 
    printf(*((char const   * __restrict  *)(_1_main_$locals + 24)), *((int *)(_1_main_$locals + 32)));
    break;
    case 4: 
