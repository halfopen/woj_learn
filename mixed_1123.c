...
extern void abort() ;
enum _1_main_$op {
    _1_main__Mult_long_long2long$right_STA_0$result_STA_0$left_STA_1 = 125,
    ...
    _1_main__Ne_int_int2int$right_STA_0$result_STA_0$left_STA_1 = 22,
    _1_main__Eq_long_long2int$left_STA_0$result_STA_0$right_STA_1 = 137,
    _1_main__goto$label_LAB_0 = 55,
    _1_main__constant_int$result_STA_0$value_LIT_0 = 7,
    _1_main__MinusA_long_long2long$left_STA_0$result_STA_0$right_STA_1 = 150,
    ...
    _1_main__store_int$left_STA_0$right_STA_1 = 254,
    _1_main__store_long$right_STA_0$left_STA_1 = 31,
    _1_main__call$func_LIT_0 = 58,
    _1_main__return_int$expr_STA_0 = 34
} ;
unsigned char _1_main_$array[1][244]  = { {        _1_main__call$func_LIT_0,        (unsigned char)1,        (unsigned char)0,        (unsigned char)0, 
            ...
            (unsigned char)0,        _1_main__goto$label_LAB_0,        (unsigned char)160,        (unsigned char)0, 
            ...
            _1_main__store_long$right_STA_0$left_STA_1,        _1_main__call$func_LIT_0,        (unsigned char)3,        (unsigned char)0, 
            (unsigned char)0,        (unsigned char)0,        _1_main__goto$label_LAB_0,        (unsigned char)123, 
            (unsigned char)255,        (unsigned char)255,        (unsigned char)255,        _1_main__call$func_LIT_0, 
            (unsigned char)1,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
            _1_main__call$func_LIT_0,        (unsigned char)1,        (unsigned char)0,        (unsigned char)0, 
            (unsigned char)0,        _1_main__call$func_LIT_0,        (unsigned char)1,        (unsigned char)0, 
            ...
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
            _1_main__Mult_long_long2long$right_STA_0$result_STA_0$left_STA_1,        _1_main__MinusA_long_long2long$left_STA_0$result_STA_0$right_STA_1,        _1_main__store_long$right_STA_0$left_STA_1,        _1_main__string$result_STA_0$value_LIT_0, 
            ...
            (unsigned char)0,        _1_main__load_long$left_STA_0$result_STA_0,        _1_main__store_long$right_STA_0$left_STA_1,        _1_main__call$func_LIT_0, 
            (unsigned char)4,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
            _1_main__goto$label_LAB_0,        (unsigned char)37,        (unsigned char)255,        (unsigned char)255, 
            (unsigned char)255,        _1_main__goto$label_LAB_0,        (unsigned char)32,        (unsigned char)255, 
...
char const   *_1_main_$strings  =    "%ld\000%ld\n\000";
